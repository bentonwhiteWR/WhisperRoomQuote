...
## Current focus (2026-05-15, afternoon — HubSpot freight/amount/tax sync fixes)
...
**On STAGING (NOT YET promoted to main):** v1.20.0 → v1.21.10 — Stripe Invoice integration, Shopify Orders drawer, Deal Hub auto-refresh, ecommerce-owner dropdown safeguards, and (today PM) HubSpot deal-level financial sync gaps fixed.
