...
async function createInvoice({ customerRef, docNumber, txnDate, lines, memo, billAddr, shipAddr, billEmail, customFields, salesTermRef, globalTaxCalc, txnTaxDetail }) {
  const { accessToken, realmId } = await getAccessToken();
  const payload = {
