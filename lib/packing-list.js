...
const FEATURE_SUBS = [
  ...
  { name: 'WA',
    ...
    resolve: (name, lineQty, ctx) => {
      ...
      // The door-adjacent wall that shrinks depends on the WA Type. 40" booths
      // (42/60/84/102 series) are dual: 4040 shrinks the door-adjacent 40" wall
      // to 31" (C01→Z01, inner K01→Z15) — this is what creates the 31" wall a
      // "WDO 31\" 1648" window swaps — while 4016 (default) shrinks the 16" wall
      // (C10→Z02). 46" booths shrink the 22" wall to 19" (default 4622).
