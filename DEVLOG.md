...
**Most recent shipped:** v1.10.4 — Fix: "Select Rate" toast was rendering "null — null applied · $undefined" (state vars cleared before toast read them). (Previous: v1.10.3 ABF Guaranteed friendly transit; v1.10.2 freight modal action restructure; v1.10.1 removed Special Instructions + Rate Only.)
...
- v1.10.2 + v1.10.3 + v1.10.4 on staging awaiting test (will promote together). Prod (main) at v1.10.0.
