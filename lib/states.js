...
const NEXUS_STATES = {
  AZ: { taxFreight: false },  // exempt if separately stated
  CA: { taxFreight: false },  // exempt if separately stated
  CO: { taxFreight: false },  // exempt if separately stated
  FL: { taxFreight: true  },  // taxable — customers cannot pick up booths
  GA: { taxFreight: true  },
  IL: { taxFreight: true  },  // taxable — no pickup option for booths
  MA: { taxFreight: false },  // exempt if separately stated
  NC: { taxFreight: true  },
  OH: { taxFreight: true  },
  PA: { taxFreight: true  },
  TN: { taxFreight: true  },
  TX: { taxFreight: true  },
  UT: { taxFreight: false },  // exempt if separately stated
  VA: { taxFreight: false },  // exempt if separately stated
  WI: { taxFreight: true  },
  WA: { taxFreight: true  },
};
