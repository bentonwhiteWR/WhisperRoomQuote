...
const RAW = {
  ...
  '102102': { mod:40, ext:[104,104], door:24,
    N:[[40,'V'],[40,'V'],[20,'S']], S:[[40,'D'],[40,'S'],[20,'S']], E:[[40,'S'],[40,'S'],[20,'S']], W:[[40,'S'],[40,'S'],[20,'S']] },
  '102126': { mod:40, ext:[128,104], door:24,
    N:[[40,'V'],[40,'V'],[44,'V']], S:[[40,'D'],[40,'S'],[44,'S']], E:[[40,'S'],[40,'S'],[20,'S']], W:[[40,'S'],[40,'S'],[20,'S']] },
  '102144': { mod:40, ext:[146,104], door:24,
    N:[[40,'V'],[40,'V'],[40,'V'],[22,'S']], S:[[40,'D'],[40,'S'],[40,'S'],[22,'S']], E:[[40,'S'],[40,'S'],[20,'S']], W:[[40,'S'],[40,'S'],[20,'S']] },
  '102168': { mod:40, ext:[170,104], door:24,
    N:[[40,'V'],[40,'V'],[40,'V'],[46,'V']], S:[[40,'D'],[40,'S'],[40,'S'],[46,'S']], E:[[40,'S'],[40,'S'],[20,'S']], W:[[40,'S'],[40,'S'],[20,'S']] },
  '102186': { mod:40, ext:[188,104], door:24,
    N:[[40,'V'],[40,'V'],[40,'V'],[40,'V'],[24,'S']], S:[[40,'D'],[40,'S'],[40,'S'],[40,'S'],[24,'S']], E:[[40,'S'],[40,'S'],[20,'S']], W:[[40,'S'],[40,'S'],[20,'S']] },
  '10284': { mod:40, ext:[86,104], door:24,
    N:[[41,'V'],[41,'V']], S:[[41,'D'],[41,'S']], E:[[40,'S'],[40,'S'],[20,'S']], W:[[40,'S'],[40,'S'],[20,'S']] },
  ...
  '6060': { mod:40, ext:[62,62], door:24,
    N:[[40,'V'],[18,'S']], S:[[40,'D'],[18,'S']], E:[[40,'S'],[18,'S']], W:[[40,'S'],[18,'S']] },
  '6084': { mod:40, ext:[86,62], door:24,
    N:[[40,'V'],[42,'V']], S:[[40,'D'],[42,'S']], E:[[40,'S'],[18,'S']], W:[[40,'S'],[18,'S']] },
  '84102': { mod:40, ext:[104,86], door:24,
    N:[[40,'V'],[40,'V'],[20,'S']], S:[[40,'S'],[40,'D'],[20,'S']], E:[[40,'S'],[42,'S']], W:[[40,'S'],[42,'S']] },
  '84126': { mod:40, ext:[128,86], door:24,
    N:[[40,'V'],[40,'V'],[44,'V']], S:[[40,'S'],[40,'D'],[44,'S']], E:[[40,'S'],[42,'S']], W:[[40,'S'],[42,'S']] },
  '8484': { mod:40, ext:[86,86], door:24,
    N:[[40,'V'],[42,'V']], S:[[40,'D'],[42,'S']], E:[[40,'S'],[42,'S']], W:[[40,'S'],[42,'S']] },
  ...
  '7272': { mod:46, ext:[74,74], door:30,
    N:[[46,'V'],[24,'S']], S:[[46,'D'],[24,'S']], E:[[46,'S'],[24,'S']], W:[[46,'S'],[24,'S']] },
  '7296': { mod:46, ext:[98,74], door:30,
    N:[[46,'V'],[48,'V']], S:[[46,'D'],[48,'S']], E:[[46,'S'],[24,'S']], W:[[46,'S'],[24,'S']] },
  '9696': { mod:46, ext:[98,98], door:30,
    N:[[47,'V'],[47,'V']], S:[[47,'D'],[47,'S']], E:[[47,'S'],[47,'S']], W:[[47,'S'],[47,'S']] },
  '96120': { mod:46, ext:[122,98], door:30,
    N:[[46,'V'],[46,'V'],[26,'S']], S:[[46,'D'],[46,'S'],[26,'S']], E:[[47,'S'],[47,'S']], W:[[47,'S'],[47,'S']] },
  '96144': { mod:46, ext:[146,98], door:30,
    N:[[47.5,'V'],[47,'V'],[47.5,'V']], S:[[47.5,'D'],[47,'S'],[47.5,'S']], E:[[47,'S'],[47,'S']], W:[[47,'S'],[47,'S']] },
  '96168': { mod:46, ext:[170,98], door:30,
    N:[[46,'V'],[46,'V'],[46,'S'],[28,'V']], S:[[46,'D'],[46,'S'],[46,'S'],[28,'S']], E:[[47,'S'],[47,'S']], W:[[47,'S'],[47,'S']] },
...
// Normalize a wall's panels so they sum EXACTLY to the interior span (drops any
// digitization rounding) while preserving each panel's relative proportion.
function normWall(panels, span, sidePrefix) {
  const raw = panels.map(p => p[0]);
  const sum = raw.reduce((a, b) => a + b, 0);
  const scale = span / sum;
  return panels.map((p, i) => ({
    id: sidePrefix + i,
    size: round(p[0] * scale),
    kind: KINDNAME[p[1]],
    prefers: PREFERS[p[1]],
  }));
}
...
for (const [name, L] of Object.entries(layouts)) {
  for (const side of ['N','S','E','W']) {
    ...
    if (Math.abs(sum - span) > 0.5) { console.log('  WARN ' + name + ' ' + side + ': panels=' + sum + ' span=' + span); warn++; }
  }
}
